...
#$ -o ../Output/Asstttt1.txt  #This is where your output and errors are logged.
...
spark-submit --driver-memory 15g --executor-memory 15g --master local[3] ../Code/Ass1_10.py