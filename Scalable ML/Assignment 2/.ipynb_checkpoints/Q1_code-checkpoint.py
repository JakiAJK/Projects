...
logFile = spark.read.text("/data/acp21jka/ScalableML/Data/NASA_access_log_Jul95.gz").cache()  # add it to cache
logFile.tail(3) # checking last few lines
...
plt.savefig("""/data/acp21jka/ScalableML/Output/Q1fig_A.png"""
            , bbox_inches='tight')
...
plt.xticks()
plt.yticks()
plt.savefig("""/data/acp21jka/ScalableML/Output/Q1fig_B.png"""
            , bbox_inches='tight')
